                ...
                Expanded(
                  child: FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final staggeredViewFotoDeMarteResponse = snapshot.data!;
                      return Builder(
                        builder: (context) {
                          final imagenes = (FotoDeMarteCall.imagenes(
                                    staggeredViewFotoDeMarteResponse.jsonBody,
                                  )?.toList() ??
                                  [])
                              .take(10)
                              .toList();
